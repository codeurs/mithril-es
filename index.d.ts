...
export declare function render(el: Element, vnodes: Children): void
...
export declare function mount(element: Element, component: null): void // tslint:disable-line unified-signatures

/** Makes an XHR request and returns a promise. */
export declare function request<T>(
	options: RequestOptions<T> & {url: string}
): Promise<T>
/** Makes an XHR request and returns a promise. */
export declare function request<T>(
	url: string,
...
export declare function jsonp<T>(
	options: JsonpOptions & {url: string}
): Promise<T> // tslint:disable-line:no-unnecessary-generics
/** Makes a JSON-P request and returns a promise. */
export declare function jsonp<T>(
	url: string,
...
export interface RouteResolver<Attrs = {}, State = {}> {
...
export type Children = Child | ChildArray | Function
...
export interface Vnode<
	Attrs = {},
	State extends Lifecycle<Attrs, State> = Lifecycle<Attrs, State>
> {
 ...
 * Components can be consumed via the m() utility.
 */
export interface ClassComponent<A = {}>
	extends Lifecycle<A, ClassComponent<A>> {
	/** The oninit hook is called before a vnode is touched by the virtual DOM engine. */
...
export type ComponentTypes<
	A = {},
	S extends Lifecycle<A, S> = Lifecycle<A, S>
> =
	| Component<A, S>
...
export declare function buildQueryString(values: {[p: string]: any}): string
